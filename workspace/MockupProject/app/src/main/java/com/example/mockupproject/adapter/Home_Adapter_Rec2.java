...
public class Home_Adapter_rec2 extends RecyclerView.Adapter<Home_Adapter_rec2.ViewHolder> {
    ...
    public Home_Adapter_rec2(Context context, ArrayList<Home_rec2DTO> list) {
    ...
    public Home_Adapter_rec2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemview = inflater.inflate(R.layout.recitem_home_rec2, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView home_rec2_tv1, home_rec2_tv2, home_rec2_tv3, home_rec2_tv4, home_rec2_tv5, home_rec2_tv6;
